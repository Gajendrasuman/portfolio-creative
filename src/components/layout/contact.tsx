      ...
      <div className="flex justify-between gap-2 flex-wrap">
        ...
        <div className="border border-text p-2 px-4 mt-10">
            ...
            <ul className="mt-2 flex flex-col gap-2">
                <Link href="mailto:gajendrasuman868@gmail.com?subject=Inquiry&body=Hi%2C%20I%20am%20interested%20in%20your%20services." target="_blank" rel="noopener noreferrer"><li className="flex gap-2 items-center text-text group"><span className="group-hover:text-primary"><IoIosMail size={24} /></span> <span>gajendrasuman868@gmail.com</span></li></Link>
                {/* <Link href="https://github.com/Gajendrasuman" target="_blank" rel="noopener noreferrer"><li className="flex gap-2 items-center text-text group"><span className="group-hover:text-primary"><FaGithub size={24} /></span> <span>@Gajendrasuman</span></li></Link> */}
