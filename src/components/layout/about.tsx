  ...
  return (
    <section id="about" className="mt-24">
      ...
      <div className="flex justify-between">
        ...
        <div className="text-text w-1/2 mt-8 flex flex-col gap-6 pr-4">
        ...
        <div className="h-fit relative">
            ...
            />
            <DotBox color="#ABB2BF" className="absolute top-1/8 -left-8" />
            <DotBox v_count={4} ygap={6} color="#ABB2BF" className="absolute top-4/7 right-0" />
        </div>
      </div>
    </section>
  );
